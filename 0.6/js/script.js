window.addEventListener('load',()=>{
    ...
    class Explosion {
        constructor(x, y, size) {
            ...
            // this.sound.src = '/0.6/audio/shoot.wav';
        ...
        draw() {
            ctx.drawImage(this.image, this.frame * this.spriteWidth, 0, this.
                spriteWidth, this.spriteHeight, this.x, this.y - this.size/4, this.
                size, this.size);
        }
    }
    ...
    function drawGameOver(){
        ...
        ctx.fillText(`GAME OVER, your score is ${score}`, canvas.width/2,canvas.
            height/2);
        ctx.fillStyle = 'white';
        ctx.fillText(`GAME OVER, your score is ${score}`, canvas.width/2 + 5,canvas.
            height/2 + 5);
    }
    ...
    window.addEventListener('click', function (e) {
        ...
        ravens.forEach(object => {
            if (object.randomColors[0] === pc[0] && object.randomColors[1] === pc
                [1] && object.randomColors[2] === pc[2]) {
                // collision detected
